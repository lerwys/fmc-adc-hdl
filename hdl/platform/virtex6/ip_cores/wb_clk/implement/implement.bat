...
xst -ifn xst.scr
move wb_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\wb_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc wb_clk.ucf wb_clk_exdes

echo 'Running map'
map -timing -pr b wb_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm wb_clk_exdes -w routed.ncd routed.v
cd ..
