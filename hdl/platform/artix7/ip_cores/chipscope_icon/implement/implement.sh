...
ngdbuild -uc ../../example_design/example_chipscope_icon.ucf -p xc7k325t-ffg900-2 -sd . example_chipscope_icon.ngc example_chipscope_icon.ngd
if [ $? -gt 0 ] ; then 
...
##-------------------------------Run map-------------------------------------------
echo 'Running map'
map -w -p xc7k325t-ffg900-2 -o example_chipscope_icon.map.ncd example_chipscope_icon.ngd
if [ $? -gt 0 ] ; then 
